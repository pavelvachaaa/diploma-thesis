...
Na tuto situaci odpovídá řešení zobrazené na #ref(<obr:arch-composition>, supplement: [obrázku]). V centru návrhu stojí transakční jádro náboru a adaptace, které nese doménová pravidla a hlavní procesní tok. K němu se připojuje prezentační vrstva obsluhující veřejný kariérní portál i interní rozhraní, datová vrstva uchovávající stav procesu, samostatná vrstva předávání zpráv pro asynchronní přeposílání úloh a událostí, integrační vrstva zajišťující řízený kontakt s okolím, auditní stopa pro dohledatelnost změn a oddělená vrstva s inteligentním zpracováním dat. Pro datově řízené rozhodování je klíčová řídicí a analytická vrstva. Ta slouží především ke sledování a vyhodnocování návštěvnosti portálů. Na plynulost systému dohlíží vrstva s provozním dohledem, která je podrobněji rozebrána v kapitole #link(<dohledovakap>)[„Dohledová vrstva a provozní měření“]. Diagram záměrně abstrahuje od konkrétních technologií, protože jejich realizační rozpad patří až do implementační kapitoly.
...
Obecný princip zachycený na #ref(<obr:arch-hexagon-principle>, supplement: [obrázku]) se v implementovaném backendu promítá do oddělení vstupních adaptérů, aplikační logiky, portů a výstupních adaptérů. Vstupní adaptéry přijímají #abbr("HTTP", none) požadavky, integrační události a další vnější signály a převádějí je na volání aplikačních služeb nebo případů užití. Porty představují kontrakty, kterými aplikační logika vyjadřuje požadavky na okolí. Výstupní adaptéry tyto porty naplňují konkrétním napojením na databázi, outbox a vrstvu zpráv, audit, autorizaci, objektové úložiště, e-mail a vnější registry. Detailnější rozpad těchto hranic je kvůli čitelnosti uveden v přílohách jako #ref(<obr:arch-backend-detail>, supplement: [obrázek]).
