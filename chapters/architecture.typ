...
Jednodušší alternativa by spočívala v lokálních účtech, globálních rolích a dodatečném filtrování podle organizace. Ta by však v prostředí #abbr("KZ", none) vedla k duplicitní správě identit a nedostatečně přesnému vyjádření vztahu uživatele ke konkrétnímu zdroji. Architektura proto odděluje přihlášení přes organizační #abbr("SSO", none)/`OIDC`, globální roli a vztahové řízení přístupu (ReBAC). Tím vytváří oporu pro NF01, NF02 a NF03, zatímco realizační detaily tohoto modelu jsou rozvedeny až v implementační kapitole.
