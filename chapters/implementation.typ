...
Architektonické principy popsané v předchozí kapitole se v implementaci promítají do konkrétního rozdělení backendu na doménové jádro, porty a technologické adaptéry. Zatímco primární adaptéry na vstupu aplikace převádějí HTTP požadavky a integrační události na volání use-cases, samotná doména ve `src/domain` zůstává odstíněna od infrastrukturních detailů.
