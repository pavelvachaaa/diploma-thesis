...
=== Teamio (Alma Career)
Teamio lze považovat za referenční #abbr("ATS", none) řešení českého trhu, zejména díky jeho úzkému propojení s dominantními inzertními kanály jobs.cz a prace.cz. Tato vazba je v podmínkách #abbr("KZ", none) významná, protože umožňuje snížit transakční náklady spojené s publikací inzerce a konsolidací reakcí uchazečů. Oficiální dokumentace současně uvádí možnost automatického importu pozic z interních systémů i z portálů provozovaných Alma Career. @teamioAutoImport2026

Z hlediska funkčního pokrytí Teamio naplňuje klíčové #abbr("ATS", none) scénáře a v komerční nabídce deklaruje i preboarding/onboarding (před nástupní a nástupní agenda) rozšíření @teamioPricing2026.  Z pohledu požadavků této práce je však zásadní provozní model produktu, který je koncipován jako služba bez lokální instalace @teamioTrial2026. Tento model je sice vhodný pro rychlé uvedení do provozu, avšak nevytváří přímý soulad s požadavkem #abbr("KZ", none) na on-premise nasazení a interní kontrolu datového provozu.
...
Orientační dohledání konkrétních produktů používaných českými zdravotnickými zařízeními ukazuje, že nemocnice veřejně nakupují především placenou inzerci a nástroje pro první fázi náboru. Ve smlouvách se opakovaně objevují služby Alma Career, například jobs.cz, prace.cz, atmoskop.cz, Práce za rohem nebo náborový #abbr("ATS", none) Teamio. Tyto služby lze dohledat například u #abbr("FN", "Fakultní nemocnice") Ostrava @registrFnoAlma2024, #abbr("FNUSA", "Fakultní nemocnice u sv. Anny v Brně") @registrFnusaAlmaNabor2025, Masarykova onkologického ústavu @registrMouTeamioProfessional2025, #abbr("FN", none) Brno @registrFnBrnoJobs2026 nebo #abbr("FN", none) Bulovka @registrBulovkaAlmaInzeraty2025.

K navrhovanému řešení mají částečně blízko širší #abbr("HRIS", none) systémy, například Vema, která uvádí moduly pro nástup a adaptaci zaměstnance @vemaZamestnaneckyPortal2026. V oblasti adaptace jsou pak veřejně dohledatelné hlavně systémy pro vzdělávání zaměstnanců, tedy LMS platformy. Ty slouží pro kurzy, školení, testy a evidenci splněného vzdělávání. Příkladem může být Moodle od PragoData Consulting ve #abbr("FN", none) Hradec Králové @registrFnhkLms2021 nebo e-learningová platforma Educasoft Solutions ve #abbr("FNUSA", none) @registrFnusaEducasoftElearning2021.
...
Při cíleném dohledání se mi nepodařilo najít český produkt, který by současně pokrýval nábor, vstupní agendu, adaptační proces a zdravotnické integrace na #abbr("NRZP", none) nebo datové zdroje akreditací Ministerstva zdravotnictví České republiky. Tyto vazby jsou přitom pro uchazeče ve zdravotnictví významné.

#abbr("NRZP", none) poskytuje rozhraní pro práci s údaji zdravotnických pracovníků @ncezKrzpApi2026. Portál akreditace.mzcr.cz zase zveřejňuje akreditační data, která jsou pro uchazeče důležitá, protože ukazují, která zdravotnická zařízení mají akreditaci pro konkrétní obory specializačního vzdělávání. Ve veřejných zdrojích se tedy nepodařilo potvrdit existenci hotového produktu, který by pokrýval stejný rozsah jako navrhované řešení.
