...
const generateApplicationUnderReviewTemplate = ({ applicantName, jobTitle, organizationName }) => {
...
<head>
    ...
    <title>Vaše přihláška se posuzuje - ${orgName}</title>
</head>
        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <p style="margin: 0; font-size: 16px; color: #4b5563;">
                    chtěli bychom Vás informovat, že Vaše přihláška na pozici <strong>${jobTitle}</strong> je nyní posuzována naším HR týmem.
                </p>
                <p style="margin-top: 15px; font-size: 16px; color: #4b5563;">
                    O dalším postupu Vás budeme co nejdříve informovat.
                </p>
            </div>
...
chtěli bychom Vás informovat, že Vaše přihláška na pozici ${jobTitle} je nyní posuzována naším HR týmem.
...
module.exports = {
    generate: generateApplicationUnderReviewTemplate
};