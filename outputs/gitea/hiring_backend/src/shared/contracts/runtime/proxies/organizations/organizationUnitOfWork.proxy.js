...
const portDefinition = require('@core/organizations/application/ports/organizationUnitOfWork.port');
...
module.exports = ({ organizationUnitOfWorkAdapter }) => {
    const service = requireServiceMethods(
        organizationUnitOfWorkAdapter,
        'organizationUnitOfWorkAdapter',
