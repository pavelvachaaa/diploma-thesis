...
const portDefinition = require('@core/roleAssignments/application/ports/roleAssignmentsUnitOfWork.port');
...
module.exports = ({ roleAssignmentsUnitOfWorkAdapter }) => {
    const service = requireServiceMethods(
        roleAssignmentsUnitOfWorkAdapter,
        'roleAssignmentsUnitOfWorkAdapter',
