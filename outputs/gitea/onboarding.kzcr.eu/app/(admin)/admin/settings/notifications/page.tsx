...
import { Bell, Mail, MessageSquare, CheckCircle, FileText, UserPlus, Loader2, Save, Users, Briefcase, Calendar, CalendarX, CheckCircle2 } from 'lucide-react'
...
const adminNotificationTypes: NotificationType[] = [
    {
        code: 'chat.message',
        label: 'Zprávy v chatu',
        description: 'Notifikace při přijetí nových zpráv od zaměstnanců',
        icon: <MessageSquare className="h-4 w-4" />
    },
    {
        code: 'onboarding.step.completed',
        label: 'Pokrok v onboardingu',
        description: 'Aktualizace o dokončení kroků onboardingu zaměstnanci',
        icon: <CheckCircle className="h-4 w-4" />
    },
    {
        code: 'document.uploaded',
        label: 'Nahrání dokumentů',
        description: 'Notifikace o nahraných a změněných dokumentech',
        icon: <FileText className="h-4 w-4" />
    },
    {
        code: 'user.created_from_applicant',
        label: 'Noví zaměstnanci',
        description: 'Notifikace při vytvoření nových zaměstnanců',
        icon: <UserPlus className="h-4 w-4" />
    },
    {
        code: 'applicant.status_changed',
        label: 'Změny stavu uchazečů',
        description: 'Notifikace o změnách stavu uchazečů o zaměstnání',
        icon: <Users className="h-4 w-4" />
    },
    {
        code: 'job.application_received',
        label: 'Nové žádosti o práci',
        description: 'Notifikace při přijetí nových žádostí o práci',
        icon: <Briefcase className="h-4 w-4" />
    },
    {
        code: 'document.approval_required',
        label: 'Požadavky na schválení',
        description: 'Notifikace o dokumentech vyžadujících schválení',
        icon: <CheckCircle className="h-4 w-4" />
    },
    {
        code: 'interview.scheduled',
        label: 'Naplánované pohovory',
        description: 'Notifikace při naplánování nového pohovoru',
        icon: <Calendar className="h-4 w-4" />
    },
    {
        code: 'interview.cancelled',
        label: 'Zrušené pohovory',
        description: 'Notifikace při zrušení pohovoru',
        icon: <CalendarX className="h-4 w-4" />
    },
    {
        code: 'onboarding.completed',
        label: 'Dokončení onboardingu',
        description: 'Notifikace o dokončení celého onboardingu zaměstnancem',
...
export default function AdminNotificationSettingsPage() {
    ...
    const handleGlobalPreferenceChange = async (key: 'inAppEnabled' | 'emailEnabled', value: boolean) => {
        ...
        try {
            ...
            toast.success('Nastavení notifikací bylo úspěšně uloženo.')
        } catch (error) {
            ...
            <div className="flex flex-col space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Spravujte způsob a čas příjmu notifikací pro administrátora
                    </p>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-6">
                            {adminNotificationTypes.map((type, index) => (
                                <div key={type.code}>
                                    ...
                                    {index < adminNotificationTypes.length - 1 && (
