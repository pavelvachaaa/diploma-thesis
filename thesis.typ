...
#show: tultemplate2.with(
  ...
  abstract: (
    cs: [
      Diplomová práce řeší digitalizaci náboru a adaptace pracovníků ve zdravotnické organizaci Krajská zdravotní, a.s., kde jsou personální procesy zatíženy průměrně 110 nástupy měsíčně, regulovanou odbornou způsobilostí a rozdílnými postupy jednotlivých odštěpných závodů. Cílem práce bylo analyzovat současný stav, určit hlavní úzká místa a navrhnout softwarové řešení, které sjednotí práci s pracovními pozicemi, uchazeči, vstupní agendou a adaptací nových zaměstnanců. Postup zpracování vycházel z procesního mapování, konzultací s uživateli, formulace funkčních a nefunkčních požadavků a rešerše dostupných systémů pro podporu náboru, adaptace a řízení lidských zdrojů. Analýza ukázala, že hlavními omezeními jsou neprovázané evidence a absence jednotného datového zdroje, předávání informací mimo jednotný systém, chybějící auditní stopa, omezené možnosti vyhodnocování procesu a papírově vedená adaptace. Rešerše zároveň potvrdila, že dostupné produkty nenaplňují současně požadavky na procesní kontinuitu, provoz na vlastní infrastruktuře, multi-tenantní členění a specifika českého zdravotnického prostředí. Výsledkem práce je návrh a implementace platformy, která propojuje kariérní portál, interní náborovou agendu, vstupní agendu a adaptační proces do jednoho řízeného toku. Součástí řešení je také napojení na externí registry, evidence změn a podpůrné funkce pro práci se životopisy a generativní tvorbu pracovních nabídek. Pilotní ověření s uživateli ukázalo, že systém je schopný zrychlit analyzované procesy a zpřehlednit odpovědnosti mezi rolemi. Další rozvoj řešení by měl směřovat zejména ke stabilizaci provozu, zpřehlednění návaznosti jednotlivých procesních kroků v portálu a postupnému rozšiřování integračních a analytických funkcí.
    ],
    en: [
      This diploma thesis deals with the digitalization of recruitment and employee onboarding in the healthcare organization Krajská zdravotní, a.s., where HR processes are affected by an average of 110 new hires per month, regulated professional qualifications, and differing procedures across individual branches. The aim of the thesis was to analyze the current state, identify the main bottlenecks, and design a software solution that unifies work with job positions, applicants, entry administration, and the onboarding of new employees. The approach was based on process mapping, user consultations, the formulation of functional and non-functional requirements, and a review of available systems supporting recruitment, onboarding, and human resource management. The analysis showed that the main limitations are disconnected records and the absence of a single data source, information transfer outside a unified system, a missing audit trail, limited options for monitoring and evaluating the process, and paper-based onboarding. The review also confirmed that available products do not simultaneously meet the requirements for process continuity, operation on the organization's own infrastructure, multi-tenant structure, and the specifics of the Czech healthcare environment. The result of the thesis is the design and implementation of a platform that connects the career portal, internal recruitment agenda, entry administration, and onboarding process into one controlled flow. The solution also includes integration with external registers, change records, and support functions for working with CVs and generating job offers. Pilot user testing showed that the system is able to speed up the analyzed processes and make responsibilities between roles clearer. Further development of the solution should focus mainly on operational stabilization, clarification of the continuity of individual process steps in the portal, and the gradual extension of integration and analytical functions.
    ],
  ),
...
#attachments(
  ...
  attach_content("Rámcový seznam otázek pro strukturované rozhovory", [
    #include "chapters/sections/process_mapping_questions.typ"
  ]),
